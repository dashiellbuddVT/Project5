...
public class Reader {
    ...
    public Reader(String fileName) throws FileNotFoundException, ParseException
    {
        accountList = readFile(fileName);
        displayAccounts(accountList);
    }
    
    public SingularlyLinkedList<Account> readFile(String fileName) throws 
    FileNotFoundException, ParseException
    {
        SingularlyLinkedList<Account> accountList = new SingularlyLinkedList<Account>();
        ...
        while (file.hasNextLine())
        {
            ...
            {
                line.close();
                throw new java.text.ParseException("not the right number of tokens", 1);
            }
            ...
            Month newMonth = new Month(monthIndex, likes, posts, followers, comments, views);
            ...
            if(!found)
            {
                Account newAccount = new Account(channelName, country, mainTopic);
